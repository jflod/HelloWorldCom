 ...
 */
/* Compiler settings for HelloWorldCom.idl:
...
#ifndef __HelloWorldCom_i_h__
#define __HelloWorldCom_i_h__
...
EXTERN_C const IID IID_IHelloWorld;
    ...
    MIDL_INTERFACE("ad103ffc-d76c-4a69-ad9a-645dff55b240")
...
#define IHelloWorld_Start(This,name,result)	\
    ( (This)->lpVtbl -> Start(This,name,result) ) 
...
#ifndef __HelloWorldComLib_LIBRARY_DEFINED__
#define __HelloWorldComLib_LIBRARY_DEFINED__

/* library HelloWorldComLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_HelloWorldComLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("ffae472e-986e-4449-b730-35deb0b2c0f4")
CompReg;
#endif
...
class DECLSPEC_UUID("7139a489-66eb-4cf1-b1b9-62f3dbfb373e")
HelloWorld;
#endif
#endif /* __HelloWorldComLib_LIBRARY_DEFINED__ */
